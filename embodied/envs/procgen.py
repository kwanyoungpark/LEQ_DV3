...
class ProcGen(embodied.Env):
  ...
  def __init__(self, task, size=(64, 64), resize='pillow', **kwargs):
    if task == 'maze':
      levels = [12, 34, 35, 55, 96, 109, 129, 140, 143, 163, 176, 204, 234, 338, 344, 369, 370, 374, 410, 430, 468, 470, 476, 491]
      cur_level = random.choice(levels)
      kwargs = {**kwargs, 'start_level': cur_level}
